...
int main()
{
    cout << "Hello world!" << endl << endl << endl << endl << endl << endl;

    ofstream excel("delete.csv"); //creates file for data to be put in, ios::app allows appending so .open doesn't overwrite
